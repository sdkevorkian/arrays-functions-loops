...
i = youngerWhile.length - 1;
while (i >= 0) {
    console.log(younger[i]);
    i--;
}

console.log("end part 4");
/*
...
function addPepperoniToPizza(pizza) {
    if (pizza.indexOf("pepperoni") === -1) {
        pizza.push("pepperoni");
    }
    return pizza;
}
var pizza1 = ['onions', 'olives', 'pineapple'];
var pizza2 = ['spinach', 'pepperoni', 'mushrooms'];

console.log(addPepperoniToPizza(pizza1));
console.log(addPepperoniToPizza(pizza2));
console.log("end part 6");
